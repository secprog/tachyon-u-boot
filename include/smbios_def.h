...
/*
 * Physical Memory Array and Memory Device Information
 */

#define SMBIOS_MEMORY_ARRAY_LOCATION_SYSTEM_BOARD	3
#define SMBIOS_MEMORY_ARRAY_USE_SYSTEM_MEMORY		3
#define SMBIOS_MEMORY_ARRAY_ECC_UNKNOWN			2
#define SMBIOS_MEMORY_ARRAY_MAX_CAPACITY_EXTENDED	0x80000000

#define SMBIOS_MEMORY_ERROR_INFO_HANDLE_NOT_PROVIDED	0xfffe

#define SMBIOS_MEMORY_DEVICE_WIDTH_UNKNOWN		0xffff
#define SMBIOS_MEMORY_DEVICE_SIZE_UNKNOWN		0xffff
#define SMBIOS_MEMORY_DEVICE_SIZE_EXTENDED		0x7fff
#define SMBIOS_MEMORY_DEVICE_SIZE_GRANULARITY_KB		0x8000
#define SMBIOS_MEMORY_DEVICE_FORM_FACTOR_UNKNOWN		2
#define SMBIOS_MEMORY_DEVICE_TYPE_UNKNOWN		2
#define SMBIOS_MEMORY_DEVICE_TYPE_DETAIL_UNKNOWN		2 /* BIT(1) */
#define SMBIOS_MEMORY_DEVICE_SPEED_UNKNOWN		0
#define SMBIOS_MEMORY_DEVICE_ATTR_UNKNOWN		0
